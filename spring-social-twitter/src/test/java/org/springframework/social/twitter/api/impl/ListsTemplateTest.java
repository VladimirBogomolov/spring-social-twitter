...
public class ListsTemplateTest extends AbstractTwitterApiTest {
    ...
    private void assertSingleList(UserList list) {
        ...
        assertEquals(1490667298000L, list.getCreatedAt().getTime());
    }
    ...
    private void assertListOfLists(List<UserList> lists) {
        ...
        assertEquals(1490667298000L, list1.getCreatedAt().getTime());
        ...
        assertEquals(1490667298000L, list2.getCreatedAt().getTime());
    }
