...
public class GeoTemplateTest extends AbstractTwitterApiTest {
    ...
    @Test
    public void getPlace_multipolygonGeometry() throws IOException {
        mockServer.expect(requestTo("https://api.twitter.com/1.1/geo/id/0bba15b36bd9e8cc.json"))
                .andExpect(method(GET))
        ...
        String placeJson = twitterObjectMapper.writeValueAsString(place);
        place = twitterObjectMapper.readValue(placeJson, Place.class);
    ...
    private void assertCoordinates(List<List<GeoPoint>> coordinates) {
